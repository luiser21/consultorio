...
if(!nombre.equals("null")){
	String consulta = "select * from area where nombrearea='"+nombre+"'";		
	ResultSet rs = con.consultar(consulta);	
	if(!(con.contar(rs)>0)){		
		String actualiza = "insert into area (nombrearea) values('"+nombre+"')";
                    ...
                    <td valign="top" height="17">
                      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="ffffff">
                        ...
                        <tr class="fondo_celda_5">
                         ...
                         <img src="img/error.gif" width="14" height="14" align="absmiddle"> &nbsp;&nbsp;&nbsp;No se pudo realizar el proceso. El area ya se encuentra registrado 
                          <%}else{%>
