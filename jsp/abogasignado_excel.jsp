...
response.setHeader ("Content-Disposition", "attachment;filename=\"abogadoasignado_excel_"+periodo+".xls\"");
%>
...
Abogados en Formacion Asignados
<p>
<table width="50%" border="1" cellpadding="0" cellspacing="1" bgcolor="#104070" style="color:#FFFFFF">
                        ...
                        <tr class="fondo_celda_2" bgcolor="#0099FF" style="color:#FFFFFF; ">
                          <td height="20" colspan="3"  align="center" class="text_negro">Casos Asignados Por Area </td>
				...
				consulta= " select * from estu_asig_temp where periodo='"+periodo+"' order by nombre";
                        ...
                        <tr class="<%= fondo %>" bgcolor="#ffffff" style="color:#000000; ">
						  ...
						  <% 
								...
								pr=pr+contar3;
								contar4=Integer.parseInt(opes[i][7]);
								pu=pu+contar4;  %>
