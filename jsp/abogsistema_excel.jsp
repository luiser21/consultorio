...
response.setHeader ("Content-Disposition", "attachment;filename=\"abogadosistematizan_excel_"+periodo+".xls\"");
%>
...
Abogados en Formacion que Sistematizan
<p>
<table width="50%" border="1" cellpadding="0" cellspacing="1" bgcolor="#104070" style="color:#FFFFFF">
                        ...
                        <tr class="fondo_celda_2" bgcolor="#0099FF" style="color:#FFFFFF; ">
                          <td height="20" colspan="3"  align="center" class="text_negro">Casos Sistematizados Por Area </td>
				...
				consulta= "select  * from estu_siste_temp where periodo='"+periodo+"' order by perabogadoss";
