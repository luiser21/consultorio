...
<form name="form1" method="post">
 ...
 <input name="" type="button" class="botones" value=" Atras " onclick='history.go(-1)'></div><br/>
  ...
  <tr class="fondo_celda_2" height="20" align="center">
    ...
    <td width="339" class="text_negro"  align="justify" height="20"><br/>     EL Radicado Ya existe.<br/>  Cambie el Numero del Radicado por otro diferente<br/><br/>  </td>
  </tr>
</table>    
    </td>
  </tr>
