...
String consulta = "select  sum(n) as n from (select count(*) as n from personacaso where perarea='"+nombre+"' union select count(*) as n from asignacion where area='"+nombre+"') as area";		

ResultSet rs = con.consultar(consulta);	
rs.next();
int cont=Integer.parseInt(rs.getString("n"));
if(cont==0){
	String actualiza = "delete from area where nombrearea='"+nombre+"'";
 ...
 <input name="" type="button" class="botones" value=" Atras " onclick="javascript:volver(document.forms['form1']);"></div>
  ...
  <table width="400" border="0" cellpadding="0" cellspacing="1"  class="fondo_tabla" align="center">
                        ...
                        <tr class="fondo_celda_5">
                          ...
                          <%}if(cont>0){%>
                           <img src="img/error.gif" width="14" height="14" align="absmiddle"> &nbsp;&nbsp;&nbsp;No se pudo realizar el proceso. El area se encuentra asignada 
                          <%}%></div><br/></td>
                        </tr>
                    </table>&nbsp;</p>
  <p>&nbsp;</p>
