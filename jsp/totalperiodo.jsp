...
<jsp:include page="menu.jsp" />
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="img/report_98470.jpg" width="100" height="100" /></td><td bgcolor="#ffffff" valign="top" width="687" align="left"> 

 <div id="pagina_contenido">
  <div class="actualizacion">Administrador - Consultorio <span></span></div>
  <h1>Informe por Periodo Lectivo: <%=periodo%></h1>
  <p></p>
  ...
  <div id="texto_contenido">
   <table width="600" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
 <div align="center" >
   <img src="img/printf.png" width="19" height="17"  title="Imprimir Informe" onClick="javascript:window.open('totalperiodo_imprimir.jsp?periodo=<%=periodo%>','popup', 'width =620, height = 800, scrollbars=yes ')" style="cursor:pointer"/>
 </div><br/>
 </td>
      </tr>
      <tr>
        <td height="91"><table width="600" border="0" align="center" cellpadding="1" cellspacing="0"  class="fondo_tabla">
                    ...
                    <td valign="top" height="17">
                      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="ffffff">
                        <tr class="fondo_celda_1">
                          <td height="20" colspan="14" align="center" class="text_blanco">Listado de Totales </td>
                        </tr>
                        <tr class="fondo_celda_2">
                          <td height="20" colspan="8"  align="center" class="text_negro">Numero de Casos Recepcionados </td>
                          <td colspan="6" align="center" class="text_negro">Fecha</td>
						  </tr>
                        <% 	
							boolean aux=true;
							Conex con = new Conex();
							ResultSet  rs = con.consultar("select count(perradicado) as total, (select COUNT(persexo) AS m from personacaso where persexo='MASCULINO' and  perid='"+periodo+"') AS m, (select COUNT(persexo) AS f from personacaso where persexo='FEMENINO' and  perid='"+periodo+"') AS f, (select max(peredad) as m from personacaso where  perid='"+periodo+"') AS maxedad, (select min(peredad) as minedad from personacaso where perid='"+periodo+"') as minedad, (select count(pertipodocumento) as cedula from personacaso where pertipodocumento='CC' and  perid='"+periodo+"')  as cedula, (select count(pertipodocumento) as ti from personacaso where pertipodocumento='TI' and  perid='"+periodo+"')  as ti, (select count(pertipodocumento) as ce from personacaso where pertipodocumento='CE' and  perid='"+periodo+"')  as ce, (select count(pertipodocumento) as rut from personacaso where pertipodocumento='RUT'  and  perid='"+periodo+"')  as rut, (select count(pertipodocumento) as nit from personacaso where pertipodocumento='NIT' and  perid='"+periodo+"') as nit, (select count(pertipodocumento) as pas from personacaso where pertipodocumento='PASAPORTE' and  perid='"+periodo+"')  as pas, (select count(pernacionalidad) as co from personacaso where pernacionalidad='COLOMBIANA' and  perid='"+periodo+"')  as co, (select count(pernacionalidad) as ve from personacaso where pernacionalidad='VENEZOLANA' and  perid='"+periodo+"')  as ve, (select count(pernacionalidad) as ot from personacaso where pernacionalidad='OTRO' and  perid='"+periodo+"')  as ot, (select((select count(pernumero) as sis from personacaso where perid='"+periodo+"') - (select count(pernumero) as sis from personacaso where pernumero='NO' and  perid='"+periodo+"'))) as to, (select count(perlibretamilitar) as pri from personacaso where perlibretamilitar='PRIMERA' and  perid='"+periodo+"')  as primera, (select count(perlibretamilitar) as seg from personacaso where perlibretamilitar='SEGUNDA' and  perid='"+periodo+"')  as seg, (select count(perlibretamilitar) as np from personacaso where perlibretamilitar='NO POSEE'  and  perid='"+periodo+"')  as np, (select count(pernumero) as uno from personacaso where pernumero='UNO' and  perid='"+periodo+"')  as uno, (select count(pernumero) as dos from personacaso where pernumero='DOS' and  perid='"+periodo+"')  as dos, (select count(pernumero) as no from personacaso where pernumero='NO' and  perid='"+periodo+"')  as  no, (select COUNT(perdiscapacidad) AS dis from personacaso where perdiscapacidad='NO' and  perid='"+periodo+"')  as dis, (select COUNT(perdiscapacidad) AS diss from personacaso where perdiscapacidad='SI' and  perid='"+periodo+"')  as diss, (select COUNT(pergrupoetnico) as gruno from personacaso where pergrupoetnico='NO' and  perid='"+periodo+"')  as  gruno, (select COUNT(pergrupoetnico) as grusi from personacaso where pergrupoetnico='SI' and  perid='"+periodo+"')  as grusi, (select COUNT(pernivelescola) AS pri from personacaso where pernivelescola='PRIMARIA' and  perid='"+periodo+"')  as pri, (select COUNT(pernivelescola) AS secu from personacaso where pernivelescola='SECUNDARIA' and  perid='"+periodo+"')  as secu, (select COUNT(pernivelescola)  as tec from personacaso where pernivelescola='TECNICO' and  perid='"+periodo+"')  as tec, (select COUNT(pernivelescola) as tecno from personacaso where pernivelescola='TECNOLOGO' and  perid='"+periodo+"')  as tecno, (select COUNT(pernivelescola) as uni from personacaso where pernivelescola='UNIVERSIDAD' and  perid='"+periodo+"')  as uni, (select COUNT(pernivelescola) as otro from personacaso where pernivelescola='OTRO' and  perid='"+periodo+"')  as otro, (select COUNT(pernivelescola) as nopo from personacaso where pernivelescola='NO POSEE' and  perid='"+periodo+"')  as nopo, (select COUNT(pertipofamilia) as  mono  from personacaso where pertipofamilia='MONOPARENTAL' and  perid='"+periodo+"')  as mono, (select COUNT(pertipofamilia) AS nuclear from personacaso where pertipofamilia='NUCLEAR' and  perid='"+periodo+"')  as nuclear, (select COUNT(pertipofamilia) as extensa from personacaso where pertipofamilia='EXTENSA' and  perid='"+periodo+"')  as extensa, (select COUNT(perestadocivil) as sol from personacaso where perestadocivil='SOLTERO' and  perid='"+periodo+"')  as sol, (select COUNT(perestadocivil) AS cas from personacaso where perestadocivil='CASADO' and  perid='"+periodo+"')  as cas, (select COUNT(perestadocivil) AS viudo from personacaso where perestadocivil='VIUDO' and  perid='"+periodo+"')  as viudo, (select COUNT(perestadocivil) as div from personacaso where perestadocivil='DIVORCIADO' and  perid='"+periodo+"')  as div, (select COUNT(perestadocivil) as libre from personacaso where perestadocivil='UNION LIBRE' and  perid='"+periodo+"')  as libre, (select COUNT(perestadocivil) as estado from personacaso where perestadocivil='OTRO' and  perid='"+periodo+"')  as estado, (SELECT COUNT(perpension) as pension from personacaso where perpension!='null' and  perid='"+periodo+"')  as pension, (SELECT COUNT(persalud) as salud from personacaso where persalud!='null' and  perid='"+periodo+"')  as salud, (SELECT COUNT(perarp) as arp from personacaso where perarp!='null' and  perid='"+periodo+"')  as arp, (SELECT COUNT(perotro) as perotro from personacaso where perotro!='null' and  perid='"+periodo+"')  as perotro, (select COUNT(perlabora) AS labora from personacaso where perlabora='SI' and  perid='"+periodo+"')  as labora, (select COUNT(perlabora) as laborano from personacaso where perlabora='NO' and  perid='"+periodo+"')  as laborano, (select COUNT(pertipotra) AS tipo from personacaso where pertipotra='INDEPENDIENTE' and  perid='"+periodo+"')  as tipo, (select COUNT(pertipotra) as asa from personacaso where pertipotra='ASALARIADO' and  perid='"+periodo+"')  as asa, (select COUNT(pertipotra) as trabajo from personacaso where pertipotra='NO' and  perid='"+periodo+"')  as trabajo, (select COUNT(perclase) as fijo from personacaso where perclase='A TERMINO FIJO' and  perid='"+periodo+"')  as fijo, (select COUNT(perclase) as ops from personacaso where perclase='PRESTACION DE SERVICIOS' and  perid='"+periodo+"')  as ops, (select COUNT(perclase) as inde from personacaso where perclase='INDEFINIDO' and  perid='"+periodo+"')  as inde, (select COUNT(perclase) as claseno from personacaso where perclase='NO POSEE' and  perid='"+periodo+"')  as claseno, (select COUNT(perclase) as claseotro from personacaso where perclase='OTRO' and  perid='"+periodo+"')  as claseotro, (select COUNT(perconflictos) as diario from personacaso where perconflictos='DIARIO' and  perid='"+periodo+"')  as diario, (select COUNT(perconflictos) as semanal from personacaso where perconflictos='SEMANAL' and  perid='"+periodo+"')  as semanal, (select COUNT(perconflictos) as ocasional from personacaso where perconflictos='OCASIONAL' and  perid='"+periodo+"')  as ocasional, (select COUNT(perconflictos) as anual from personacaso where perconflictos='ANUAL' and  perid='"+periodo+"')  as anual, (select COUNT(perfactor) as economico from personacaso where perfactor='ECONOMICO' and  perid='"+periodo+"')  as economico, (select COUNT(perfactor) as escolar from personacaso where perfactor='ESCOLAR' and  perid='"+periodo+"')  as escolar, (select COUNT(perfactor) as roles from personacaso where perfactor='MANEJO DE ROL' and  perid='"+periodo+"') as roles, (select COUNT(perfactor) as autoridad from personacaso where perfactor='MANEJO DE AUTORIDAD' and  perid='"+periodo+"')  as autoridad, (select COUNT(parautor) as padre from personacaso where parautor='PADRE-MADRE' and  perid='"+periodo+"')  as padre, (select COUNT(parautor) as hijo from personacaso where parautor='PADRE-HIJOS' and  perid='"+periodo+"')  as hijo, (select COUNT(parautor) as hermano from personacaso where parautor='HERMANOS' and  perid='"+periodo+"')  as hermano, (select COUNT(parautor) as otro from personacaso where parautor='OTROS' and  perid='"+periodo+"') as perotros, (select COUNT(pervivienda) as casa from personacaso where pervivienda='CASA' and  perid='"+periodo+"')  as casa, (select COUNT(pervivienda) as apto from personacaso where pervivienda='APTO' and  perid='"+periodo+"')  as apto, (select COUNT(pervivienda) as habitacion from personacaso where pervivienda='HABITACION' and  perid='"+periodo+"')  as habitacion, (select COUNT(pervivienda) as rancho from personacaso where pervivienda='RANCHO' and  perid='"+periodo+"')  as rancho, (select COUNT(pervivienda) as lote from personacaso where pervivienda='CASA LOTE' and  perid='"+periodo+"')  as lote, (select COUNT(pervivienda) as otros from personacaso where pervivienda='OTRO' and  perid='"+periodo+"')  as perviviotros, (select COUNT(pertenencia) as propia from personacaso where pertenencia='PROPIA' and  perid='"+periodo+"')  as propia, (select COUNT(pertenencia) as arrendada from personacaso where pertenencia='ARRENDADA' and  perid='"+periodo+"')  as arrendada, (select COUNT(pertenencia) as amortizada from personacaso where pertenencia='AMORTIZADA' and  perid='"+periodo+"')  as amortizada, (select COUNT(pertenencia) as inquilinato from personacaso where pertenencia='INQUILINATO' and  perid='"+periodo+"')  as inquilinato, (select COUNT(pertenencia) as sucesion from personacaso where pertenencia='SUCESION' and  perid='"+periodo+"')  as sucesion, (select COUNT(pertenencia) as otrosvi from personacaso where pertenencia='OTRO' and  perid='"+periodo+"')  as otrosvi, (select COUNT(pertenencia) as invasion from personacaso where pertenencia='INVASION' and  perid='"+periodo+"')  as invasion, (select COUNT(pertenencia) as hipoteca from personacaso where pertenencia='HIPOTECA' and  perid='"+periodo+"')  as hipoteca, (select COUNT(perdesplazado) as si from personacaso where perdesplazado='SI' and  perid='"+periodo+"')  as si, (select COUNT(perdesplazado) as no from personacaso where perdesplazado='NO' and  perid='"+periodo+"')  as nodesplazado, (select COUNT(perjuridica) as sii from personacaso where perjuridica='SI' and  perid='"+periodo+"')  as sii, (select COUNT(perjuridica) as noo from personacaso where perjuridica='NO' and  perid='"+periodo+"')  as noo, (select COUNT(perarea) AS publica from personacaso where perarea='PUBLICA' and  perid='"+periodo+"')  as publica, (select COUNT(perarea) AS privada from personacaso where perarea='PRIVADA' and  perid='"+periodo+"')  as privada, (select COUNT(perarea) AS laboral from personacaso where perarea='LABORAL' and  perid='"+periodo+"')  as laboral, (select COUNT(perarea) AS penal from personacaso where perarea='PENAL' and  perid='"+periodo+"')  as penal, (select COUNT(peragua) AS agua from personacaso where peragua='Agua' and  perid='"+periodo+"')  as agua, (select COUNT(perluz) AS luz from personacaso where perluz='Luz' and  perid='"+periodo+"')  as luz, (select COUNT(peralcantarillado) AS agua from personacaso where peralcantarillado='Alcantarillado' and  perid='"+periodo+"')  as alcantarillado, (select COUNT(paralumbrado) AS luz from personacaso where paralumbrado='Alumbrado Publico' and  perid='"+periodo+"')  as alumbrado, (select COUNT(pertelefonos) AS luz from personacaso where pertelefonos='Telefono' and  perid='"+periodo+"')  as telefono, (select COUNT(peraseo) AS luz from personacaso where peraseo='Recoleccion de Aseo' and  perid='"+periodo+"')  as aseo, (SELECT count(perrango) as rango4  FROM personacaso where  perid='"+periodo+"' and perrango='25 - 35 anos') as rango4, (SELECT count(perrango) as rango4  FROM personacaso where  perid='"+periodo+"' and perrango='18 - 25 anos') as rango3, (SELECT count(perrango) as rango4  FROM personacaso where  perid='"+periodo+"' and perrango='35 - 50 anos') as rango5, (SELECT count(perrango) as rango4  FROM personacaso where  perid='"+periodo+"' and perrango='mayor 50 anos') as rango6, (SELECT count(perrango) as rango4  FROM personacaso where  perid='"+periodo+"' and perrango='0 - 14 anos') as rango1, (SELECT count(perrango) as rango4  FROM personacaso where  perid='"+periodo+"' and perrango='14 - 18 anos') as rango2  from personacaso where  perid='"+periodo+"'");	
                        ...
                        <tr class="fondo_celda_5">
                          ...
                          <td height="20" colspan="6" class="text_negro"><div align="center">Desde el&nbsp;&nbsp;<%					  
                          ...
                          <tr class="fondo_celda_1">
                            ...
                            <td height="20" colspan="6" align="center" class="text_blanco" >Nacionalidad</td>
                          </tr>
                          <tr class="fondo_celda_2">
                            ...
                            <td width="70" colspan="2" align="center" class="text_negro" >Otros</td>
                          </tr>
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20" colspan="2" align="center" class="text_negro" ><%= opes[i][13] %></td>
                          </tr>
                          <tr class="fondo_celda_1">
                            <td height="20" colspan="8" align="center" class="text_blanco" >Hombres con Libreta Militar </td>
                            <td height="20" colspan="6" align="center" class="text_blanco" >Personas que poseen SISBEN = <%= opes[i][14] %></td>
                            </tr>
                          <tr class="fondo_celda_2">
                            ...
                            <td height="20" colspan="2" align="center" class="text_negro" >No Poseen </td>
                          </tr>
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20" colspan="2" align="center" class="text_negro" ><%= opes[i][20] %></td>
                          </tr>
                          <tr class="fondo_celda_1">
                            <td height="20" colspan="6" align="center" class="text_blanco" >Personas con Discapacidad </td>
                            <td height="20" colspan="8" align="center" class="text_blanco" >Personas pertenecientes a Grupos Etnicos </td>
                            </tr>
                          <tr class="fondo_celda_2">
                          ...
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20" colspan="4" align="center" class="text_negro" ><%= opes[i][24] %></td>
                            </tr>
                          <tr class="fondo_celda_1">
                            <td height="20" colspan="8" align="center" class="text_blanco" >Personas Con nivel de Escolaridad </td>
                            <td height="20" colspan="6" align="center" class="text_blanco" >Tipo de Familias </td>
                            </tr>
                          <tr class="fondo_celda_2">
                            ...
                            <td height="20" colspan="2" align="center" class="text_negro" >Extensa</td>
                          </tr>
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20" colspan="2" align="center" class="text_negro" ><%= opes[i][34] %></td>
                          </tr>
                          <tr class="fondo_celda_1">
                            <td height="20" colspan="14" align="center" class="text_blanco" >Estado Civil </td>
                            </tr>
                          <tr class="fondo_celda_2">
                            ...
                            <td height="20" colspan="4" align="center" class="text_negro" >Otro</td>
                            </tr>
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20" colspan="4" align="center" class="text_negro" ><%= opes[i][40] %></td>
                            </tr>
							<tr class="fondo_celda_1">
                            <td height="20" colspan="14" align="center" class="text_blanco" >Informacion Laboral </td>
                            </tr>
                          <tr class="fondo_celda_2">
                            ...
                            <td height="20" colspan="8" align="center" class="text_negro" >Clase de Contrato </td>
                            </tr>
                          ...
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20"  colspan="3" align="center" class="text_negro" ><%= opes[i][53] %></td>
                          </tr>
                          <tr class="fondo_celda_2">
                            <td height="20" colspan="14" align="center" class="text_negro" >Se encuentra afiliado a la Seguridad Social </td>
                            </tr>
                          <tr class="fondo_celda_4">
                          ...
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20" colspan="4" align="center" class="text_negro" ><%= opes[i][44]%></td>
                            </tr>
							<tr class="fondo_celda_1">
                            <td height="20" colspan="14" align="center" class="text_blanco" >Resoluci&oacute;n de Conflictos </td>
                          </tr>
                          <tr class="fondo_celda_2">
                            <td height="20" colspan="6" align="center" class="text_negro" >Frecuencia en que se presentan los Conflictos en el Hogar </td>
                            <td height="20" colspan="8" align="center" class="text_negro" >Factor que ocasiona el conflicto </td>
                            </tr>
                          <tr class="fondo_celda_4">
                            ...
                            <td height="20" align="center" colspan="3" class="text_negro" >Manejo de Autoridad</td>
                            </tr>
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20" align="center"  colspan="3" class="text_negro" ><%= opes[i][62] %></td>
                          </tr>
                          <tr class="fondo_celda_2">
                            <td height="20" colspan="6" align="center" class="text_negro" >Autores del Conflicto </td>
                            <td height="20" colspan="8" align="center" class="text_negro" >Tipo de Vivienda </td>
                            </tr>
                          <tr class="fondo_celda_4">
                            ...
                            <td width="70" height="20" colspan="2" align="center" class="text_negro" >Otro</td>
                          </tr>
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20" colspan="2" align="center" class="text_negro" ><%= opes[i][72] %></td>
                          </tr>
                          <tr class="fondo_celda_2">
                            <td height="20" colspan="14" align="center" class="text_negro" >Tenencia</td>
                            </tr>
                          <tr class="fondo_celda_4">
                          ...
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20" colspan="3" align="center" class="text_negro" ><%= opes[i][78] %></td>
                          </tr>
                          <tr class="fondo_celda_2">
                            <td height="20" colspan="14" align="center" class="text_negro" >Servicios</td>
                            </tr>
                          <tr class="fondo_celda_4">
                            ...
                            <td height="20" colspan="4" align="center" class="text_negro" >Recoleccion de Aseo </td>
                          </tr>
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20" colspan="4" align="center" class="text_negro" ><%= opes[i][94]%></td>
                            </tr>
                           <tr class="fondo_celda_1">
                            <td height="20" colspan="14" align="center" class="text_blanco" >Historial de Atenci&oacute;n </td>
                            </tr>
                          <tr class="fondo_celda_2">
                            <td height="20" colspan="7" align="center" class="text_negro" >Se encuentra en situaci&oacute;n de Desplazamiento </td>
                            <td height="20" colspan="7" align="center" class="text_negro" >Ha iniciado acciones juridicas previas </td>
                            </tr>
                          <tr class="fondo_celda_4">
                            <td height="20" colspan="4" align="center" class="text_negro" >SI</td>
                            <td height="20" colspan="3" align="center" class="text_negro" >NO</td>
                          ...
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20" colspan="4" align="center" class="text_negro" ><%= opes[i][84] %></td>
                            </tr>
                          <tr class="fondo_celda_1">
                            <td height="20" colspan="14" align="center" class="text_blanco" > Area de Consulta </td>
                            </tr>
                          <tr class="fondo_celda_2">
                            ...
                            <td height="20" colspan="4" align="center" class="text_negro" >Penal </td>
                            </tr>
                          <tr class="fondo_celda_5">
                            ...
                            <td height="20" colspan="4" align="center" class="text_negro" ><%= opes[i][88] %></td>
                            </tr>
							<%}
							}else{
							aux=false; }%>
                            <tr class="fondo_celda_1">
                            <td height="20" colspan="14" align="center" class="text_blanco" >Casos Por Municipio (Norte de Santander - Venezuela)</td>
                            </tr>
                          <tr class="fondo_celda_2">
                            ...
                            <td height="20" colspan="4" align="center" class="text_negro" >Total</td>
                          </tr>
                            <% 	
							boolean auxmun=true;
							...
							int y=0;
							ResultSet  rsmuni = mun.consultar("(SELECT municipio, count(municipio) as total FROM personacaso where perid='"+periodo+"' group by municipio order by municipio asc) EXCEPT (SELECT municipio, count(municipio) as total FROM personacaso where perid='"+periodo+"' and municipio='SAN ANTONIO DEL TACHIRA' group by municipio order by municipio asc)");	
							
							ResultSet  rsmunive = munve.consultar("SELECT municipio, count(municipio) as total FROM personacaso where perid='"+periodo+"' and municipio='SAN ANTONIO DEL TACHIRA' group by municipio order by municipio asc");							int contmunive = munve.contar(rsmunive);
						...
						if(opesmun[i][0]!=null){	%>                          
                          <tr class="<%= fondo %>">
							...
							y=y+dep;
							%>
                            <td height="20" colspan="4" align="center" class="text_negro" ><div align="center"><%= opesmun[i][1] %> </div></td>                            
                          </tr>
                          <%}}
					}else{
					auxmun=false;
				 %><tr align="center" class="fondo_celda_5">
                          <td height="20" class="text_negro" colspan="14">No se encontraron registros.</td>                        </tr>   <%}%>               
						   ...
						   <tr class="fondo_celda_2"> 
                            ...
                            <td height="20" colspan="4" align="center" class="text_negro" ><div align="center">Total</div></td>                            
                          </tr><% int j=0;
                          ...
                          <tr class="<%= fondo %>">
							...
							j=j+dep;%>
                            <td height="20" colspan="4" align="center" class="text_negro" ><div align="center"><%= opesmunve[i][1] %> </div></td>
                          </tr>
						  <%}
					}else{
					auxmunve=false;
				 %><tr align="center" class="fondo_celda_5">
						  ...
						  <tr align="center" class="fondo_celda_2">
						    ...
						    <td height="20" colspan="4" class="text_negro"><%=y+j%></td>
						    </tr>   
                    </table></td>
                  </tr>
                <%  
