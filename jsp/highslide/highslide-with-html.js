...
skin : {
	contentWrapper:
		'<div class="highslide-header" onmouseout="return hs.close(this)"><ul>'+
			'<li class="highslide-previous" onmouseout="return hs.close(this)">'+
			...
			'<li class="highslide-close">'+
				'<a href="#" title="{hs.lang.closeTitle}" onmousemove="return hs.close(this)">'+
				'<span>{hs.lang.closeText}</span></a>'+
			'</li>'+
		'</ul></div>'+
		'<div class="highslide-body" onmouseout="return hs.close(this)"></div>'+
