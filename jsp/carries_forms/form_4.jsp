...
ResultSet  cones = conesd.consultar("SELECT perapeabog, perabogado from personacaso where perid='"+periodo+"' and perdocu='"+codigo+"' group by perabogado, perapeabog");		
cones.next();
...
<body>
  <p class="ver">Ver Casos   Recepcionados   / Periodo: <%=periodo%>  <br/>Estudiante: <%=cones.getString("perabogado")%>  <%=cones.getString("perapeabog")%> </p>
    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="ffffff">
        ...
        <% 	
							...
							ResultSet  rs = con.consultar("select *  from personacaso where perid='"+periodo+"' and perdocu='"+codigo+"' and perarea='LABORAL' order by perradicado");	
    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="ffffff">
        ...
        <% 	
							...
							ResultSet  rsi = coni.consultar("select *  from personacaso where perid='"+periodo+"' and perdocu='"+codigo+"' and perarea='PENAL'  order by perradicado");	
    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="ffffff">
        ...
        <% 	
							...
							ResultSet  rsii = conii.consultar("select *  from personacaso where perid='"+periodo+"' and perdocu='"+codigo+"' and perarea='PRIVADA'  order by perradicado");	
    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="ffffff">
        ...
        <% 	
							...
							ResultSet  rsiii = coniii.consultar("select *  from personacaso where perid='"+periodo+"' and perdocu='"+codigo+"' and perarea='PUBLICA'  order by perradicado");	
