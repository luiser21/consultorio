...
<form name="form1" method="post">
 ...
 <input name="" type="button" class="botones" value=" Atras " onclick="javascript:volver(document.forms['form1']);"></div>
  ...
  <table width="350" border="0" align="center" cellpadding="1" cellspacing="0" class="fondo_tabla">
                    ...
                    <td valign="top" height="17">
                      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="ffffff">
                        ...
                        <tr class="fondo_celda_5">
                          <td height="20"  align="center"><input type="text" name="nombre" class="text_file" size="25" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" ></td>
                          </tr>
                    </table>
					</td>
                  </tr>
                  ...
                  <tr>
                    <td align="right" class="fondo_celda_3"><input name="" type="button" class="botones" value=" Registrar " onclick="javascript:registrar(document.forms['form1']);"> </td>
                  </tr>              
                </table>&nbsp;</p>
  <p>&nbsp;</p>
</form>				
