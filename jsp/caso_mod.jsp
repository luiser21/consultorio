...
a&ntilde;os 
            ...
            <option value="<%=rs.getString("pertipodocumento")%>"><%=rs.getString("pertipodocumento")%></option>
                              ...
                              <td height="20" align="center" class="text_negro"><input type="text"  name="lugarexpedicion"  size="20" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("perlugarexpedicion")%>"/></td>
