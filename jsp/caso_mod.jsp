...
String radicado=String.valueOf(request.getParameter("radicado"));
...
var s = "no";
	...
	/*}else if(esVacio(frm.lugarexpedicion.value)){	
      ...
      frm.action = "modificarcaso_Msg.jsp";
      frm.submit();
	}
}
</SCRIPT>
...
<script>
            ...
            <table width="650" border="0" cellspacing="1" cellpadding="0" class="fondo_tabla">
                            ...
                            <tr class="fondo_celda_1">
                              ...
                              <td  rowspan="2"  align="center" class="text_blanco"><span>RADICADO No. 
                                  &nbsp;&nbsp;<input name="codigo" type="text"  class="validate[required,custom[integer]] text_file" onFocus="javascript:prender();" onBlur="javascript:apagar();" value="<%=radicado%>"   size="5" id="codigo">
      <input name="codigo_real"  type="hidden"   value="<%=radicado%>" >
                              </span></td>
                            </tr>
                            <tr class="fondo_celda_1">
                              <td  align="center" class="text_blanco2"><span>
                              <input  name="fecha" type="text" id="cal-field-2"  size="10" maxlength="10" class="text_file" onfocus="this.blur()" value="<%=rs.getString("perfecha")%>" />
                            ...
                            <tr class="fondo_celda_5">
                              <td height="20"  align="center"><input value="<%=rs.getString("pernombre")%>" name="nombre" type="text"  onFocus="javascript:prender();" onBlur="javascript:apagar();"  id="nombre" class="validate[required] text_file" size="20"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();"></td>
                              <td height="20"  align="center"><input value="<%=rs.getString("perapellido")%>" name="apellido" type="text" class="validate[required] text_file" onFocus="javascript:prender();" id="apellido" onBlur="javascript:apagar();"  size="20" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();"></td>
 ...
 <option value="<%=rs.getString("persexo")%>"><%=rs.getString("persexo")%></option>
                                  <option value="FEMENINO">Femenino</option>
                                  <option value="MASCULINO">Masculino</option>
                                </select>
                              </span></td>
                              <td height="20"   align="center" class="text_negro"><input  name="edad" type="text"  class="validate[required,custom[integer]] text_file"  size="2"  value="<%=rs.getString("peredad")%>" id="edad"/>
a&ntilde;os 
                                &nbsp;&nbsp;&nbsp;
                                <select name="rango"  class="validate[required] combos"  id="rango">
            <option value="<%=rs.getString("perrango")%>"><%=rs.getString("perrango")%></option>
            ...
            <option value="<%=rs.getString("pertipodocumento")%>"><%=rs.getString("pertipodocumento")%></option>
                              ...
                              <td height="20" align="center" class="text_negro"><input type="text" name="documento"  size="20"  class="validate[required,custom[integer]] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);" value="<%=rs.getString("perdocumento")%>"/></td>
                              <td height="20" align="center" class="text_negro"><input type="text"  name="lugarexpedicion"  size="20" class="validate[required] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("perlugarexpedicion")%>"/></td>
                              <td height="20" align="center" class="text_negro"><select name="nacionalidad"  class="validate[required] combos" >
                               
        <option value="<%=rs.getString("pernacionalidad")%>"><%=rs.getString("pernacionalidad")%></option>                         <option value="COLOMBIANA">COLOMBIANA</option>
  ...
  <option selected="selected" value="<%=rs.getString("perlibretamilitar")%>"><%=rs.getString("perlibretamilitar")%></option>                      
                                <option value="PRIMERA" >PRIMERA</option>
                                <option value="SEGUNDA" >SEGUNDA</option>
                                <option value="NO POSEE" >NO POSEE</option>
                              </select></td>
                              
        <%if(rs.getString("perlibretamilitar").equals("PRIMERA") || rs.getString("perlibretamilitar").equals("SEGUNDA")){%>
        
                 <td height="20" align="center" class="text_negro">                             
        <input type="text" name="numeroli"  size="20"  class="validate[required,custom[integer]] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);"   id="aparece15" style="display:inline" value="<%=rs.getString("pernumerolibreta")%>" /></td>
                                      <td height="20" colspan="2" align="center" class="text_negro"><input type="text"  value="<%=rs.getString("perdistritomilitar")%>" name="dismil"  size="30" class="validate[required] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" id="aparece16" style="display:inline" /></td>
             
                                      
<%}else{%>                                      
		
		<%	if(rs.getString("pernumerolibreta").equals("null")){%>         
            <td height="20" align="center" class="text_negro">                             
<input type="text" name="numeroli"  size="20"  class="validate[required,custom[integer]] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);"   id="aparece15" style="display:none" /></td>
       ...
       <%}else{%>                       
                              ...
                              <td height="20" align="center" class="text_negro">                             
<input type="text" name="numeroli"  size="20"  class="validate[required,custom[integer]] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);"   id="aparece15" style="display:none" value="<%=rs.getString("pernumerolibreta")%>"/></td>
                              <td height="20" colspan="2" align="center" class="text_negro"><input type="text"  name="dismil"  size="30" class="validate[required] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" id="aparece16" style="display:none" value="<%=rs.getString("perdistritomilitar")%>"/></td>
            <%}
	   }%>
                            </tr>
                            <tr class="fondo_celda_2">
                            ...
                            <tr class="fondo_celda_5">
                              <td height="20" align="center"  colspan="2" class="text_negro"><input type="text" name="direccion"  size="40" class="validate[required] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("perdireccion")%>"/></td>
                              <td height="0" align="center" class="text_negro" ><select name="municipio"  class="validate[required] combos" >
<option value="<%=rs.getString("municipio")%>"><%=rs.getString("municipio")%></option>
                              ...
                              <td height="0"  align="center" class="text_negro" ><span class=" text_negro"><select name="embarazada" class="combos">
                                <option value="<%=rs.getString("embarazada")%>"><%=rs.getString("embarazada")%></option>
                              </select>
                            ...
                            <tr class="fondo_celda_5" >
                              <td height="20" align="center" class="text_negro"><input type="text" name="telefono"  class="validate[required,custom[integer]] text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);"  value="<%=rs.getString("pertelefono")%>"/></td>
                              <td height="20" align="center"  colspan="1"class="text_negro"><input type="text" name="email"  size="20"  class="text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);" value="<%=rs.getString("peremail")%>"/></td>
                              <td height="20" align="center" class="text_negro">

<select name="sisben" onChange="agregarOpciones(this.form)" class="validate[required] combos">
<option selected="selected" value="<%=rs.getString("persisben")%>"><%=rs.getString("persisben")%></option>
<option value="SI">SI</option>
<option value="NO"  >NO</option>
</select></td>
                              <td height="20"  colspan="2"align="center" class="text_negro" >Numero:   &nbsp;&nbsp;&nbsp;<select name="numerosisben"  class="combos">
                               <option value="<%=rs.getString("pernumero")%>"  selected="selected"><%=rs.getString("pernumero")%></option>
                              </select>
             ...
             <option value="<%=rs.getString("perdiscapacidad")%>" selected="selected"><%=rs.getString("perdiscapacidad")%></option>                          
                                  <option value="SI">SI</option>
                                  <option value="NO" >NO</option>
                                </select>
                              </span></td>
                              <td height="20"  colspan="3" align="center" class="text_negro">Tipo de Discapacidad: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input name="tipodis" type="text" class="validate[required] text_file"   size="50" maxlength="40" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);"  value="<%=rs.getString("pertipodisca")%>" id="aparece" style="display:none"></td>
                            </tr>
                            <tr class="fondo_celda_2"  >
          ...
          <option value="<%=rs.getString("pergrupoetnico")%>" selected="selected"><%=rs.getString("pergrupoetnico")%></option>                         
                                  <option value="SI">SI</option>
                                  <option value="NO"> NO</option>
                                </select>
                              </span></td>
                              <td height="20"  colspan="3" align="center" class=" text_negro"><span class="text_negro">
                                &iquest;Cual?: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="text" name="etnico"  size="50" class="validate[required] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" id="aparece2" value="<%=rs.getString("percualetnico")%>" style="display:none"/>
                              </span></td>
                            </tr>
                            <tr class="fondo_celda_2">
          ...
          <option value="<%=rs.getString("pernivelescola")%>" selected="selected"><%=rs.getString("pernivelescola")%></option>                       
                              ...
                              <input type="text" name="otro"  size="50" class="validate[required] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" id="aparece3" style="display:none" value="<%=rs.getString("percualnivel")%>"/></td>
  </tr>
...
<td height="20" align="center" class="text_negro">Tipo de Familia </td>
                       ...
                       <option value="<%=rs.getString("pertipofamilia")%>" selected="selected"><%=rs.getString("pertipofamilia")%></option>                       
                              ...
                              <td height="20" align="center" class="text_negro"><input type="text" name="modofamil"  size="20" class="validate[required] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("permodofamil")%>"/></td>
                              <td height="20" colspan="2" align="center" class="text_negro"><input type="text"  name="personasgrupo"  value="<%=rs.getString("pernumfamilia")%>" size="10" class="validate[required,custom[integer]] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
              ...
              <option value="<%=rs.getString("perestadocivil")%>" selected="selected"><%=rs.getString("perestadocivil")%></option>     
                              ...
                              <td height="20" colspan="3" align="center" class="text_negro"><input type="text" name="conyuge"  size="45" class="text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("perconyuge")%>"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                            ...
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="2" align="center" class="text_negro"><input type="text" name="allegado"  size="45" class="validate[required] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("perallegado")%>"/></td>
                              <td height="20" colspan="2" align="center" class="text_negro"><input type="text" name="telefonofijo"  size="20" class="validate[custom[integer]] text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);" value="<%=rs.getString("perfijo")%>"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                            ...
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="2" align="center" class="text_negro"><input type="text" name="direccionalle"  size="45" class="validate[required] text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("perdireccionalle")%>"/></td>
                              <td height="20" colspan="2" align="center" class="text_negro"><input type="text" name="telefonocel"  size="20" class="validate[custom[integer]] text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);" value="<%=rs.getString("percelular")%>"/></td>
  </tr>
          ...
          <table width="650" border="0" cellspacing="1" cellpadding="0" class="fondo_tabla">
                ...
                <tr  class="fondo_celda_5">
                  <td height="20" align="center" class="text_negro"><input type="text" name="autoridad"  size="30" class="validate[required] text_file"  onchange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("perautoridad")%>"/></td>
                  <td height="20" align="center" class="text_negro"><input type="text" name="sanciona"  size="30" class="validate[required] text_file"   value="<%=rs.getString("persanciona")%>" onchange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();"/></td>
                  <td height="20" colspan="2" align="center" class="text_negro"><input type="text" name="aporte"  size="20" class="validate[required,custom[integer]] text_file" value="<%=rs.getString("peraporte")%>" /></td>
                </tr>
                <tr class="fondo_celda_2">
                ...
                <tr class="fondo_celda_5">
                  ...
                  <option value="<%=rs.getString("perconflictos")%>" selected="selected"><%=rs.getString("perconflictos")%></option>                   
                  ...
                  <td height="20" align="center" class="text_negro"><select name="factor"  id="select7"  class="validate[required] combos" >
                   <option value="<%=rs.getString("perfactor")%>" selected="selected"><%=rs.getString("perfactor")%></option>         
                  ...
                  <td height="20" colspan="2" align="center" class="text_negro"><select name="autor"  id="select11" class="validate[required] combos" >
                     <option value="<%=rs.getString("parautor")%>" selected="selected"><%=rs.getString("parautor")%></option>       
               ...
               <option value="<%=rs.getString("pervivienda")%>" selected="selected"><%=rs.getString("pervivienda")%></option>  
                  ...
                  <td height="20" align="center" class="text_negro"><select name="tenencia"  class="validate[required] combos" >
                             <option value="<%=rs.getString("pertenencia")%>" selected="selected"><%=rs.getString("pertenencia")%></option>  
                  ...
                  <td height="20" colspan="2" align="center" class="text_negro">
                   <%if(rs.getString("peragua").equals("null")){%>
								 <input type="checkbox" name="agua" value="Agua" id="servicios_0">Agua
								 <%}else{%>
                                  <input type="checkbox" name="agua" value="<%=rs.getString("peragua")%>" id="servicios_0"  checked="checked">
                                  Agua<%}%>
                                
                              <%if(rs.getString("perluz").equals("null")){%>
								  <input type="checkbox" name="luz" value="Luz" id="servicios_1">Luz
								   <%}else{%>
                                  <input type="checkbox" name="luz" value="<%=rs.getString("perluz")%>" id="servicios_1" checked="checked">
                                  Luz<%}%>
                                
                                <%if(rs.getString("peralcantarillado").equals("null")){%>
								 <input  type="checkbox" name="alcantarillado" value="Alcantarillado" id="servicios_2">Alcantarillado
								 <%}else{%>
                                  <input  type="checkbox" name="alcantarillado" value="<%=rs.getString("peralcantarillado")%>" id="servicios_2" checked="checked">
                                  Alcantarillado<%}%>
                                
                               <BR/>
                                
                               <%if(rs.getString("paralumbrado").equals("null")){%>
								<input type="checkbox" name="alumbrado" value="Alumbrado Publico" id="servicios_3">Alumbrado P&uacute;blico
								<%}else{%>
                                  <input type="checkbox" name="alumbrado" value="<%=rs.getString("paralumbrado")%>" id="servicios_3" checked="checked">
                                  Alumbrado P&uacute;blico<%}%>
                               
                                
                               <%if(rs.getString("pertelefonos").equals("null")){%>
								 <input type="checkbox" name="telefonos" value="Telefono" id="servicios_4">Tel&eacute;fono
								 <%}else{%>
                                  <input type="checkbox" name="telefonos" value="<%=rs.getString("pertelefonos")%>" id="servicios_4" checked="checked">
                                  Tel&eacute;fono<%}%><br/>
                               <%if(rs.getString("peraseo").equals("null")){%>
								<input type="checkbox" name="aseo" value="Recoleccion de Aseo" id="servicios_5">Recolecci&oacute;n de Aseo
								 <%}else{%>
                                  <input type="checkbox" name="aseo" value="<%=rs.getString("peraseo")%>" id="servicios_5">
  ...
  <tr class="fondo_celda_2">
   <td height="20" colspan="4" align="center" class="text_negro">Ocupacion</td>
                            ...
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><input type="text" name="ocupacion"  size="40" class="text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();"  value="<%=rs.getString("perocupacion")%>" /></td>
                            </tr>
                            <tr class="fondo_celda_2">
                            ...
                            <tr class="fondo_celda_5">
                              <td height="20" align="center" class="text_negro"><select name="labora"  class="validate[required] combos">
                                  <option value="<%=rs.getString("perlabora")%>" selected="selected"><%=rs.getString("perlabora")%></option>         
                                  <option value="SI">SI</option>
                                <option value="NO" >NO</option>                                
                              </select></td>
                              <td height="20" align="center" class="text_negro"><input type="text"  name="salario"  size="10" class="validate[required,custom[integer]] text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);" value="<%=rs.getString("persalario")%>" /></td>
                              <td height="20" colspan="2" align="center" class="text_negro"><select name="tipotra"  class="combos" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);">
                                <option value="<%=rs.getString("pertipotra")%>" selected="selected"><%=rs.getString("pertipotra")%></option>         
                            ...
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="2" align="center" class="text_negro"><input type="text" name="empresa"  size="30" class="text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("perempresa")%>"/></td>
                             ...
                             <%if(rs.getString("perclase").equals("") || rs.getString("perclase").equals("null")){%>
                                <option value="NO POSEE" selected="selected">NO POSEE</option>
                             <%}else{%>   
                              <option value="<%=rs.getString("perclase")%>" selected="selected"><%=rs.getString("perclase")%></option>  
                              <%}%>
                            ...
                            <tr class="fondo_celda_5">
							  ...
							  <input type="checkbox" name="salud" value="Salud" id="servicios_6">Salud

							  <%}else{%>
                                <input type="checkbox" name="salud"  checked="checked" value="<%=rs.getString("persalud")%>" id="servicios_6">
                                Salud  <%}%>
                                <%if(rs.getString("perpension").equals("null")){%>
								 <input type="checkbox" name="pension" value="Pension" id="servicios_7">Pension
								 <%}else{%>
                                  <input type="checkbox" name="pension" value="<%=rs.getString("perpension")%>" id="servicios_7" checked="checked">
                                  Pension                            <%}%>
                           <%if(rs.getString("perarp").equals("null")){%>
								 <input type="checkbox" name="arp" value="Arp" id="servicios_8">Arp
								  <%}else{%>
                                  <input type="checkbox" name="arp" value="<%=rs.getString("perarp")%>" id="servicios_8" checked="checked">
                                ARP<%}%>
                                <%if(rs.getString("perotro").equals("null")){%>
								  <input type="checkbox" name="otrosalud" value="Otro" id="servicios_919">Otro
								  <%}else{%>
                                  <input type="checkbox" name="otrosalud" value="<%=rs.getString("perotro")%>" id="servicios_919" checked="checked">
                                  Otro <%}%>
                              <br></td>
                              <td height="20" colspan="2" align="center" class="text_negro">
                              
                              
                              <input type="text" name="ocupaconyu"  size="30" class="text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("perocupaconyu")%>" /></td>
  </tr>
           ...
           <table width="650" border="0" cellspacing="1" cellpadding="0" class="fondo_tabla">
                            ...
                            <tr class="fondo_celda_5">
                              <td height="20" align="center" class="text_negro"><select name="desplazado"  class="validate[required] combos" onChange="activar4(this.form)">
                                <option value="<%=rs.getString("perdesplazado")%>" selected="selected"><%=rs.getString("perdesplazado")%></option>
                                  <option value="SI">SI</option>
                                <option value="NO">NO</option>
                                </select>                              </td>
                              <td height="20" colspan="3" align="center" class="text_negro"><input type="text" name="lugardes"  size="40" class="text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();"  value="<%=rs.getString("perlugardes")%>" id="aparece4" style="display:inline"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                            ...
                            <tr class="fondo_celda_5">
                              <td height="20" align="center" class="text_negro">
             <input  name="fechades" type="text" id="cal-button-2_des" size="10" maxlength="10" style="display:inline"  value="<%=rs.getString("perfechades")%>" class="text_file">
                            <img src="img/calendario.gif" width="15" height="16" hspace="5" align="absmiddle" border="0" id="cal-button-2_des"  style="display:inline"/>
                              
                              </td>
                              <td height="20" colspan="3" align="center" class="text_negro"><input type="text" name="motivo"  size="40" class="text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("permotivo")%>" id="aparece6" style="display:inline"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Actor Armado que produce el desplazamiento</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><input type="text" name="armado"  size="40" class="text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("perarmado")%>" id="aparece7" style="display:inline"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Grupo familiar con el que se desplaza</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><input type="text" name="grupo"  size="40" class="text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("pergrupo")%>" id="aparece8" style="display:inline"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Se encuentra incluido dentro del RUPD</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><input type="text" name="rupd"  size="40" class="text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" id="aparece9" value="<%=rs.getString("perrupd")%>" style="display:inline"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                            ...
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><textarea name="relacion"  cols="60" rows="6" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();"  id="aparece10" style="display:inline"><%=rs.getString("perrelacion")%></textarea></td>
                            </tr>
                            <tr class="fondo_celda_2">
                            ...
                            <%}else{%>
                              ...
                              <td height="20" colspan="3" align="center" class="text_negro"><input type="text" name="lugardes"  size="40" class="text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();"  value="<%=rs.getString("perlugardes")%>" id="aparece4" style="display:none"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" align="center" class="text_negro">Fecha del Desplazamiento</td>
                              <td height="20" colspan="3" align="center" class="text_negro">Motivo del Desplazamiento</td>
                            ...
                            <tr class="fondo_celda_5">
                              <td height="20" align="center" class="text_negro"><input  name="fechades" type="text" id="cal-field-2_des"  size="10" maxlength="10" style="display:none"  value="<%=rs.getString("perfechades")%>" class="text_file"/>
                            <img src="img/calendario.gif" width="15" height="16" hspace="5" align="absmiddle" border="0" id="cal-button-2_des"  style="display:none"/>
                   </td>
                              <td height="20" colspan="3" align="center" class="text_negro"><input type="text" name="motivo"  size="40" class="text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("permotivo")%>" id="aparece6" style="display:none"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Actor Armado que produce el desplazamiento</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><input type="text" name="armado"  size="40" class="text_file"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("perarmado")%>" id="aparece7" style="display:none"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Grupo familiar con el que se desplaza</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><input type="text" name="grupo"  size="40" class="text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("pergrupo")%>" id="aparece8" style="display:none"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Se encuentra incluido dentro del RUPD</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><input type="text" name="rupd"  size="40" class="text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" id="aparece9" value="<%=rs.getString("perrupd")%>" style="display:none"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Relacion de Orientacion o asesorias de publica o privada recibidas</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><textarea name="relacion"  cols="60" rows="6" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();"  id="aparece10" style="display:none"><%=rs.getString("perrelacion")%></textarea></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" align="center" class="text_negro">Ha iniciado acciones juridicas previas</td>
                              <td height="20" colspan="3" align="center" class="text_negro">Cuales</td>
                            </tr>
                        <%}if(rs.getString("perjuridica").equals("SI")){%>
                        
                          <tr class="fondo_celda_5">
                              <td height="20" align="center" class="text_negro">
                              
                              <select name="juridica"  class="validate[required] combos" onChange="activar5(this.form)">
                                   <option value="<%=rs.getString("perjuridica")%>" selected="selected"><%=rs.getString("perjuridica")%></option> 
                                <option value="SI">SI</option>
                                <option value="NO" >NO</option>
                              </select></td>
                              <td height="20" colspan="3" align="center" class="text_negro"><textarea name="cuales"  cols="30" rows="2" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" id="aparece11" style="display:inline"><%=rs.getString("percuales")%></textarea></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Modalidad de la Atencion</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><input type="text" name="modalidad"  size="40" class="text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("permodalidad")%>" id="aparece12" style="display:inline"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Caso (Exposicion de la ruta de acceso al derecho)</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><textarea name="caso"   cols="60" rows="6" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" id="aparece13" style="display:inline"><%=rs.getString("percaso")%></textarea></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Asesoria: (El derecho a proteger - Ruta de Acceso al Derecho)</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><textarea name="asesoria" cols="60" rows="6" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" id="aparece14" style="display:inline"><%=rs.getString("perasesoria")%></textarea></td>
  </tr>
  ...
  <%}else{%>
                            <tr class="fondo_celda_5">
                              ...
                              <td height="20" colspan="3" align="center" class="text_negro"><textarea name="cuales"  cols="30" rows="2" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" id="aparece11" style="display:none"><%=rs.getString("percuales")%></textarea></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Modalidad de la Atencion</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><input type="text" name="modalidad"  size="40" class="text_file" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" value="<%=rs.getString("permodalidad")%>" id="aparece12" style="display:none"/></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Caso (Exposicion de la ruta de acceso al derecho)</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><textarea name="caso"   cols="60" rows="6" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" id="aparece13" style="display:none"><%=rs.getString("percaso")%></textarea></td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20" colspan="4" align="center" class="text_negro">Asesoria: (El derecho a proteger - Ruta de Acceso al Derecho)</td>
                            </tr>
                            <tr class="fondo_celda_5">
                              <td height="20" colspan="4" align="center" class="text_negro"><textarea name="asesoria" cols="60" rows="6" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" id="aparece14" style="display:none"><%=rs.getString("perasesoria")%></textarea></td>
  </tr>
<%}%>
</table>
        </fieldset>
 ...
 <tr class="fondo_celda_2">
  ...
  <tr class="fondo_celda_5">
 <td height="20"  align="center"  colspan="3" class="text_negro"><textarea name="exposicion"  cols="60" rows="6" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" class="validate[required]"><%=rs.getString("perexposicion")%></textarea></td>
                            </tr>
                            <tr class="fondo_celda_2">
                            ...
                            <tr  class="fondo_celda_5">
                              <td height="20"   colspan="3" align="center" class="text_negro" >
							       ...
							       <%if(rs.getString("perarea").equals("PUBLICA")){%>
                              
								   <input type="radio" name="area" value="PUBLICA" checked="checked">&nbsp;&nbsp;PUBLICA&nbsp;&nbsp;&nbsp;                              
                             
								   <input type="radio" name="area" value="PRIVADA">&nbsp;&nbsp;PRIVADA&nbsp;&nbsp;&nbsp;
                            
								   <input type="radio" name="area" value="PENAL">&nbsp;&nbsp;PENAL&nbsp;&nbsp;&nbsp;                              
                           
								   <input type="radio" name="area" value="LABORAL">&nbsp;&nbsp;LABORAL&nbsp;&nbsp;&nbsp;                               
                                   
							           <%}%>
                                         <%if(rs.getString("perarea").equals("PRIVADA")){%>
                           
								   <input type="radio" name="area" value="PUBLICA" >&nbsp;&nbsp;PUBLICA&nbsp;&nbsp;&nbsp;                              
                              
								   <input type="radio" name="area" value="PRIVADA" checked="checked">&nbsp;&nbsp;PRIVADA&nbsp;&nbsp;&nbsp;
								   ...
								   <input type="radio" name="area" value="LABORAL">&nbsp;&nbsp;LABORAL&nbsp;&nbsp;&nbsp;                               
							           ...
							           <%}%>
                                         <%if(rs.getString("perarea").equals("PENAL")){%>
                           
								   <input type="radio" name="area" value="PUBLICA" >&nbsp;&nbsp;PUBLICA&nbsp;&nbsp;&nbsp;                              
                      
								   <input type="radio" name="area" value="PRIVADA" >&nbsp;&nbsp;PRIVADA&nbsp;&nbsp;&nbsp;
                            
								   <input type="radio" name="area" value="PENAL" checked="checked">&nbsp;&nbsp;PENAL&nbsp;&nbsp;&nbsp;                              
                         
								   <input type="radio" name="area" value="LABORAL">&nbsp;&nbsp;LABORAL&nbsp;&nbsp;&nbsp;                               
                                   
							           <%}%>
                                          <%if(rs.getString("perarea").equals("LABORAL")){%>
								   ...
								   <input type="radio" name="area" value="LABORAL" checked="checked">&nbsp;&nbsp;LABORAL&nbsp;&nbsp;&nbsp;                               
                            ...
                            <tr  class="fondo_celda_5">
                              <td height="20"   colspan="3" align="center" class="text_negro"><textarea name="observaciones" cols="60" rows="4" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();"><%=rs.getString("perobservaciones")%></textarea></td>
                            </tr>
                            <tr class="fondo_celda_2">
                            ...
                            <tr class="fondo_celda_5">
                              <td height="20"  colspan="2" align="center" class="text_blanco"><span class="text_negro">
                                <textarea name="docucopias"  cols="50" rows="4" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();"><%=rs.getString("perdocumentos")%></textarea>
                              </span></td>
                              <td height="20"  align="center" class="text_blanco"><select name="recibido"  class="validate[required] combos" >
                                  <option value="<%=rs.getString("perrecibido")%>" selected="selected"><%=rs.getString("perrecibido")%></option>
                                  <option value="SI">SI</option>
                                <option value="NO">NO</option>
                              </select></td>
                            </tr>
                            <tr class="fondo_celda_1">
                              <td height="25"  colspan="3" align="center" class="text_blanco">ABOGADO EN FORMACION QUE RECEPCIONA</td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20"align="center" class="text_negro">Nombres</td>
                              <td align="center" class="text_negro">Apellidos</td>
                              <td height="20"  align="center" class="text_negro">Documento de Indentidad </td>

                            </tr>
                            <tr  class="fondo_celda_5">
                              <td height="20" align="center" class="text_negro">
                                <input type="text" name="abogado" size="20" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();"  value="<%=rs.getString("perabogado")%>" class="validate[required] combos">
                             </td>
                              <td align="center" class="text_negro"><input type="text" name="apeabog" size="20" value="<%=rs.getString("perapeabog")%>"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" class="validate[required] combos"></td>
                              <td height="20"  align="center" class="text_negro"><input type="text" name="docu"  value="<%=rs.getString("perdocu")%>" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);" class="validate[required,custom[integer]] combos"></td>
                            </tr>
                            
                            <tr class="fondo_celda_1">
                              <td height="20"  colspan="3"align="center" class="text_negro"><span class="text_blanco">ABOGADO EN FORMACION ASIGNADO</span></td>
                            </tr>
                            <tr class="fondo_celda_2">
							...
							if(es==null){%>							
							 <tr >
                             <td height="20" colspan="3"align="center" class="text_negro">No posee Abogado Asignado</td>
                            </tr>
							<%}	if(es!=null){
                            ...
                            <tr class="fondo_celda_5">
                              ...
                              <td height="20"  align="center" class="text_negro"><%=ress.getString("identificacion")%></td>
                            </tr><%}%>
                            
                            <tr class="fondo_celda_1">
                              <td height="23"  colspan="3" align="center" class="text_blanco">ABOGADO EN FORMACION QUE SISTEMATIZA </td>
                            </tr>
                            <tr class="fondo_celda_2">
                              <td height="20"align="center" class="text_negro">Nombre</td>
                              <td align="center" class="text_negro">Apellido</td>
                            ...
                            <tr  class="fondo_celda_5">
                              <td height="20"align="center" class="text_negro"><input type="text" name="abogado3"  value="<%=rs.getString("perabogadoss")%>" size="20"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" class="validate[required] combos"></td>
                              <td align="center" class="text_negro"><input type="text" name="apeabog3" size="20" value="<%=rs.getString("perapeabogss")%>"  onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);this.value=this.value.toUpperCase();" class="validate[required] combos"></td>
                              <td height="20"  align="center" class="text_negro"><input type="text" name="docu3" value="<%=rs.getString("perdocuss")%>" onChange="javascript:while(''+this.value.charAt(0)==' ')this.value=this.value.substring(1,this.value.length);" class="validate[required,custom[integer]] combos"></td>
  </tr>
