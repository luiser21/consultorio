...
<div id="container">
  ...
  <table id="chartData" width="450px">
    ...
    <tr style="color: #0DA068">
      <td>SuperWidget</td><td>1.12</td>
    </tr>

    <tr style="color: #194E9C">
      <td>MegaWidget</td><td>1.00</td>
    </tr>

    <tr style="color: #ED9C13">
      <td>HyperWidget</td><td>7.49</td>
    </tr>

    <tr style="color: #ED5713">
      <td>WonderWidget</td><td>326.27</td>
    </tr>

    <tr style="color: #057249">
      <td>MicroWidget</td><td>612.06</td>
    </tr>

    <tr style="color: #5F91DC">
      <td>NanoWidget</td><td>1.11</td>
    </tr>

    <tr style="color: #F88E5D">
      <td>LovelyWidget</td><td>2.55</td>
    </tr>
  </table>
</div>
